...
const processSteps = [
  {
    ...
    description: (
      <>
        ...
        무리해서 당기면 흉터가 넓어지고, 전두부 모발이 빠지는 동반탈락 현상이
        생깁니다.
        <br />
        <br />
  ...
  },
  {
    ...
    description: (
      <>
        이마축소술 후 모발이식이 필요할지, 잔머리는 얼마나 살릴지, 기존 모발
        사이에 흉터는 어떻게 숨길지, 모발의 방향과 두께도 고려해서, 절개선을
        디자인합니다.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        모낭을 다치지 않게 절개하는 것이 중요합니다. 모낭이 손상되면 절개선
        주변의 모발이 빠질 수 있습니다.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        건막을 절개하면 두피의 움직임이 자유로워집니다. 이렇게 하면 봉합 시
        장력이 줄어들어 흉터가 작아집니다.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        두피를 고정하는 것은 매우 중요합니다. 고정이 제대로 되지 않으면 시간이
        지나면서 두피가 다시 올라갈 수 있습니다.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        겹겹이 봉합하여 피부에 걸리는 장력을 없애줍니다. 이렇게 하면 대부분의
        흉터는 가느다란 실선으로 남습니다.
      </>
    ),
