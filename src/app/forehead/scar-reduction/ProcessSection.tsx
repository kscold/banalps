...
const processSteps = [
  {
    ...
    descriptionMobile: (
      <>
        ...
        무리해서 당기면 흉터가 넓어지고,
        <br />
        전두부 모발이 빠지는 동반탈락 현상이
        <br />
        생깁니다.
        <br />
        <br />
        성공적인 이마축소를 위해선 두피의 특성을
        <br /> 파악하는 것이 중요합니다.
      </>
    ),
  ...
  },
  {
    ...
    descriptionMobile: (
      <>
        건막절개술은 단단한 건막에 일정한 <br /> 간격으로 절개선을 넣어 두피가
        충분히 <br /> 늘어나도록 해주는 과정입니다.
        <br />
        <br />
        건막절개 없는 단순한 이마축소 보다
        <br />
  ...
  },
  {
    ...
    descriptionMobile: (
      <>
        ...
        <br />
        <br />
        엔도타인이 두피를 최대한 당겨서 걸어줄 수
        <br />
        있고, 고정력도 더 뛰어나다고 생각해서
        <br />
        엔도타인 방식을 고집합니다.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        이제 피부의 가장자리를 매끈하게 맞춰 주기만 하면 됩니다.
      </>
    ),
    descriptionMobile: (
      <>
        피하 봉합이 끝나면 아직 피부 봉합은
        <br />
        하지도 않았는데 절개선의 피부면이 이미
        <br />
        딱 붙어있습니다.
        <br />
        <br />
    ...
    <div ref={ref} className={styles.processStepOdd}>
      ...
      <div className={styles.stepContent}>
        ...
        <h3 className={styles.stepTitle}>
          {isMobile && step.titleMobile ? step.titleMobile : step.title}
        </h3>
