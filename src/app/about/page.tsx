...
export default function AboutPage() {
  ...
  const getCardTransition = (delay: number = 0) =>
    prefersReducedMotion ? { duration: 0 } : { duration: 0.5, delay, ease: 'easeOut' as const };
  ...
  return (
    <div ref={containerRef} className={styles.aboutPage} suppressHydrationWarning>
      ...
      <div ref={videoRef} className={styles.videoSection} suppressHydrationWarning>
        {currentSection >= 0 && <VideoSection showVideoSection={true} onVideoEnd={() => {}} onVideoReady={() => {}} />}
      </div>
                ...
                {isMobile ? (
                  <div className={styles.heroQuoteMobile}>
                    <h1 className={styles.heroQuote}>
                      {language === 'KR' && '\u2018'}
                      {(() => {
                        const quoteText = (t.hero as any).quoteMobile || t.hero.quote;
          ...
          <section className={styles.valuesSection}>
            <div className={styles.valuesContainer}>
              <div className={styles.valuesContent}>
                ...
                <p className={styles.valuesDescription} suppressHydrationWarning>
                  {(() => {
                    const text =
                      isMobile && t.values.mobileDescription ? t.values.mobileDescription : t.values.description;
              ...
              <div className={styles.valuesCards}>
                <img
                  src={language === 'JP' ? '/about/value-jp.svg' : '/about/value.svg'}
                  alt="바날 가치"
                  className={styles.valueCardsImage}
                />
                <img
                  src={language === 'JP' ? '/about/mobile/value-mobile-jp.svg' : '/about/mobile/value-mobile.svg'}
                  alt="바날 가치"
            ...
            <div className={styles.strengthsContainer}>
              <div className={styles.strengthsContent}>
                ...
                <div className={styles.strengthsLeftSection}>
                  ...
                  <img src="/about/about-graffiti.svg" alt="바날 소개 그래피티" className={styles.strengthsGraffiti} />
                </div>
                ...
                <div className={styles.strengthsList}>
                  ...
                  {strengths.map((strength, index) => (
                    ...
                    >
                      <div className={styles.strengthNumberMobile}>{strength.number}</div>
                      <div className={styles.strengthItemContentMobile}>
                        <h3 className={styles.strengthItemTitleMobile}>
                          {(strength.mobileTitle || strength.title).split('\n').map((line, index) => (
                            <span key={index}>
                              {line}
                              {index < (strength.mobileTitle || strength.title).split('\n').length - 1 && <br />}
                            </span>
                          ))}
                        </h3>
                        <p className={styles.strengthDescriptionMobile} suppressHydrationWarning>
                          {(() => {
                            const text = strength.mobileDescription || strength.description;
                            const lines = text.split('\n');
                            return lines.map((line, index) => (
                              <span key={index}>
                                {line}
          ...
          <section className={styles.gallerySection}>
            <div className={styles.galleryContainer}>
              ...
              <div className={styles.galleryTopSection}>
                ...
                >
                  <img src="/about/gallery/gallery-1.png" alt="바날 갤러리 메인" className={styles.galleryImage} />
                </motion.div>
              </div>
              ...
              <div className={styles.galleryGrid}>
                ...
                <div className={styles.galleryRow1}>
                  ...
                  >
                    <img src="/about/gallery/gallery-2.png" alt="바날 갤러리 2" className={styles.galleryImage} />
                  </motion.div>
                  ...
                  >
                    <img src="/about/gallery/gallery-3.png" alt="바날 갤러리 3" className={styles.galleryImage} />
                  </motion.div>
                  ...
                  >
                    <img src="/about/gallery/gallery-4.png" alt="바날 갤러리 4" className={styles.galleryImage} />
                  </motion.div>
                </div>
                ...
                <div className={styles.galleryRow2}>
                  ...
                  >
                    <img src="/about/gallery/gallery-5.png" alt="바날 갤러리 5" className={styles.galleryImage} />
                  </motion.div>
                  ...
                  >
                    <img src="/about/gallery/gallery-6.png" alt="바날 갤러리 6" className={styles.galleryImage} />
                  </motion.div>
                </div>
                ...
                <div className={styles.galleryRow3}>
                  {isMobile ? (
                    ...
                    <>
                      ...
                      >
                        <img src="/about/gallery/gallery-7.png" alt="바날 갤러리 7" className={styles.galleryImage} />
                      </motion.div>
