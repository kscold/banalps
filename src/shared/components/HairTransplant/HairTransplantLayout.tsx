    ...
    <>
                        ...
                        ...(section1.illustrationMobileSize
                          ? {
                              ...
                              ...(section1.illustrationMobileSize.fullWidth
                                ? {
                                    height: section1.illustrationMobileSize
                                      .height
                                      ? mvw(
      ...
      <section
        ...
        style={
          isMobile
            ? {
                ...(section2.mobileHeight
                  ? { minHeight: mvw(section2.mobileHeight) }
                  : {}),
                ...(section2.sectionPaddingBottom !== undefined
                  ? { paddingBottom: section2.sectionPaddingBottom }
                  : {}),
              }
            : undefined
        }
            ...
            <>
              ...
              <div className={styles.section2Left}>
                <div
                  className={
                    scarReduction
                      ? styles.section2TextScarReduction
                      : styles.section2Text
                  }
                >
                  <h2
                        ...
                        section2.imagesMobileSize
                          ? {
                              height: section2.imagesMobileSize.mainHeight
                                ...
                                : undefined,
                              width: section2.imagesMobileSize.mainMaxWidth
                                ? "100vw"
                                : "100%",
                              marginLeft: section2.imagesMobileSize.mainMaxWidth
                                ? `calc(-1 * ${mvw(16)})`
                                : undefined,
                              marginRight: section2.imagesMobileSize
                                .mainMaxWidth
                                ? `calc(-1 * ${mvw(16)})`
                                : undefined,
                            }
                    ...
                    >
                      <img
                        ...
                        style={{
                          width: "100%",
                          height: "100%",
                          objectFit: section2.illustrationMobileSize?.fullWidth
                            ? "cover"
                            : "contain",
                        }}
                      />
                            ...
                            section3.titleMarginBottom !== undefined
                              ? {
                                  marginBottom: isMobile
                                    ? mvw(40) // Always use mvw(40) for mobile
                                    : `${
                                        (section3.titleMarginBottom / 1920) *
                                        100
                                      }vw`,
                                }
                              : undefined
        ...
        <div className={styles.beforeAfterContent}>
          ...
          {beforeAfterButton && (
            <div className={styles.beforeAfterActions}>
              <Link
                href={beforeAfterButton.href || "/before-after"}
