          ...
          <div className={styles.content}>
            {type === "terms" ? (
              <div className={styles.termsContent}>
                ...
                <p>제5조(이용계약의 성립)</p>
                <p>
                  이용계약은 이용자의 이용신청에 대한 병원의 승낙과 이용자의
                  약관 내용에 대한 동의로 성립됩니다.
                </p>
                <br />
                <p>제6조(이용신청)</p>
                <p>
                  이용신청은 서비스의 회원정보 화면에서 이용자가 병원에서
                ...
                <p>제9조(병원의 의무)</p>
                <p>
                  사는 서비스 제공과 관련해서 알고 있는 회원의 신상 정보를
                ...
                <p>
                  ...
                  이용하여 발생한 결과에 대하여 병원는 책임을 지지 않습니다.
                </p>
                <p>
                ...
                <p>
                  회원은 병원에서 제공하는 자료를 임의로 삭제, 변경할 수
                  없습니다.
                </p>
                <p>
                  회원은 병원의 홈페이지에 공공질서 및 미풍양속에 위반되는
                ...
                <p>
                  ...
                  <br />
                  병원의 저작권, 제3자의 저작권 등 기타 권리를 침해하는 내용인
                  경우
                  <br />
                  회원이 병원의 홈페이지와 게시판에 음란물을 게재하거나 음란
                  사이트를 링크하는 경우
                  <br />
                ...
                <p>
                  ...
                  결과 및 손실, 관계기관에 의한 법적 조치 등에 관하여는 병원는
                  책임을 지지 않습니다.
                </p>
                <br />
                <p>제16조(서비스 제공의 중지)</p>
                ...
                <p>
                  ...
                  통하여 해지신청을 하여야 하며, 병원에서는 본인 여부를 확인 후
                  조치합니다.
                </p>
                <p>
                  병원는 회원이 다음 각 호에 해당하는 행위를 하였을 경우
                ...
                <p>제19조(손해배상)</p>
                <p>
                  병원는 무료로 제공되는 서비스와 관련하여 회원에게 어떠한
                  손해가 발생하더라도 동 손해가 병원의 고의 또는 중대한 과실로
                  인한 손해를 제외하고 이에 대하여 책임을 부담하지 아니합니다.
                </p>
                <br />
                <p>제20조(면책 조항)</p>
                <p>
                  병원는 천재지변, 전쟁 또는 기타 이에 준하는 불가항력으로
                  인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한
                  책임이 면제됩니다.
                </p>
                <p>
                  병원는 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한
                  사유로 발생한 손해에 대한 책임이 면제됩니다.
                </p>
                <p>
                  병원는 회원의 귀책사유로 인한 서비스이용의 장애에 대하여
                  책임을 지지 않습니다.
                </p>
                <p>
                  병원는 회원이 서비스를 이용하여 기대하는 이익이나 서비스를
                  통하여 얻는 자료로 인한 손해에 관하여 책임을 지지 않습니다.
                </p>
                <p>
                  병원는 회원이 서비스에 게재한 정보, 자료, 사실의 신뢰도,
                  정확성 등의 내용에 관하여는 책임을 지지 않습니다.
                </p>
                <br />
                <p>제21조(관할법원)</p>
                <p>
                  서비스 이용으로 발생한 분쟁에 대해 소송이 제기 될 경우 병원의
              ...
              <div className={styles.privacyContent}>
                <p>
                  해당 홈페이지에 &lt;바람부는날에도성형외과의원&gt;(
                  ‘www.banalps.com’이하 ’바람부는날에도성형외과의원
                  홈페이지')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호
                  및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게
                  처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
                </p>
                <br />
                <p>
                  &lt;바람부는날에도성형외과의원&gt;(’바람부는날에도성형외과의원
                ...
                <h4>1. 개인정보의 처리 목적</h4>
                <p>
                  &lt;바람부는날에도성형외과의원&gt;( ‘www.banalps.com’ 이하
                  ’바람부는날에도성형외과의원 홈페이지')은(는) 개인정보를 다음의
                  목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의
                  용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를
                  구할 예정입니다.
                </p>
                <p>
                  가. 홈페이지 회원가입 및 관리
                  ...
                  나. 마케팅 및 광고에의 활용
                  <br />
                  이벤트 및 광고성 정보 제공 및 참여기회 제공 , 접속빈도 파악
                ...
                <p>
                  ①
                  &lt;바람부는날에도성형외과의원&gt;('바람부는날에도성형외과의원
                  홈페이지')은(는) 법령에 따른 개인정보 보유•이용기간 또는
                ...
                <p>
                  ① &lt;바람부는날에도성형외과의원&gt;( ‘www.banalps.com '이하
                  '바람부는날에도성형외과의원 홈페이지')은(는) 정보주체의 동의,
                  법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에
                  해당하는 경우에만 개인정보를 제3자에게 제공합니다.
                </p>
                <p>
                  ② &lt;바람부는날에도성형외과의원&gt;( ‘www.banalps.com’)은(는)
                ...
                <p>
                  ① 정보주체는 바람부는날에도성형외과의원(‘www.banalps.com 이하
                  ‘바람부는날에도성형외과의원 홈페이지) 에 대해 언제든지 다음 각
                ...
                <p>
                  ② 제1항에 따른 권리 행사는
                  바람부는날에도성형외과의원(‘www.banalps.com 이하
                  ‘바람부는날에도성형외과의원 홈페이지) 에 대해 개인정보 보호법
                  시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX)
                  등을 통하여 하실 수 있으며 &lt;기관/회사명&gt;(‘사이트URL’이하
                  ‘사이트명) 은(는) 이에 대해 지체 없이 조치하겠습니다.
                </p>
                <p>
                  ③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한
                  경우에는 &lt;기관/회사명&gt;(‘사이트URL’이하 ‘사이트명) 은(는)
                  정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나
                  제공하지 않습니다.
                </p>
                <p>
                ...
                <p>
                  ① &lt;바람부는날에도성형외과의원&gt;( ‘www.banalps.com 이하
                  '바람부는날에도성형외과의원 홈페이지')은(는) 다음의 개인정보
                  항목을 처리하고 있습니다.
                </p>
                <p>
                  1. &lt;홈페이지 회원가입 및 관리&gt;
                  <br />- 필수항목 : 이메일, 휴대전화번호, 자택주소, 비밀번호,
                  로그인ID, 이름, 접속 로그, 접속 IP 정보
                </p>
                <br />
                <h4>7. 개인정보의 파기</h4>
                <p>
                ...
                <p>
                  ① 바람부는날에도성형외과의원(‘www.banalps.com’ 이하
                  ‘바람부는날에도성형외과의원 홈페이지) 은(는) 개인정보 처리에
                ...
                <br />
                <p>
                  귀하께서는 병원의 서비스를 이용하시며 발생하는 모든
                  개인정보보호 관련 민원을 개인정보관리책임자로 신고하실 수
                  있습니다. 병원은 이용자들의 신고사항에 대해 신속하게 충분한
                ...
                <p>
                  ...
                  <br />
                  정보보호마크인증위원회 (http://www.eprivacy.or.kr / (02)
                  580-0533~4)
                  <br />
                  대검찰청 사이버범죄수사단 (http://www.spo.go.kr / (02)
                  3480-3573)
                  <br />
                  경찰청 사이버테러대응센터 (http://www.ctrc.go.kr / (02)
                  392-0330)
                </p>
              </div>
            )}
